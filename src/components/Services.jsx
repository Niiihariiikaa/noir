...
export default function Services() {
  return (
    <section className="border-b border-ink/60">
      {/* Row 1: [ What we Build â€” spans 2 cols ][ image ][ BRAND & WEB DESIGN ] */}
      <div className="grid grid-cols-1 border-b border-ink/60 md:min-h-90 md:grid-cols-4 md:divide-x md:divide-ink/60">
        <div className="flex min-h-75 flex-col justify-between border-b border-ink/60 p-6 md:col-span-2 md:border-b-0 md:p-8">
          <span className="self-start border border-ink px-4 py-2 text-[9px] tracking-[0.25em]">
            OUR SERVICES
          </span>
        ...
        <div className="flex flex-col justify-center">
          <p className="border-y border-ink/60 py-3 text-center text-[10px] tracking-[0.22em]">
            BRAND &amp; WEB DESIGN
          </p>
          <p className="px-8 py-5 text-justify text-[10px] leading-relaxed text-ink/75">
      ...
      <div className="grid grid-cols-1 md:min-h-120 md:grid-cols-4 md:divide-x md:divide-ink/60">
        <div className="border-b border-ink/60 md:border-b-0">
          <p className="border-b border-ink/60 py-3 text-center text-[10px] tracking-[0.22em]">
            SOCIAL &amp; CONTENT
          </p>
          <p className="px-6 py-6 text-justify text-[10px] leading-relaxed text-ink/75">
