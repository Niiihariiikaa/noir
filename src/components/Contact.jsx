...
export default function Contact() {
  return (
    <section id="contact" className="border-b border-ink/60">
      <div className="grid grid-cols-1 md:min-h-200 md:grid-cols-2">
        <div className="md:border-r md:border-ink/60">
          <img
            src={letsconnect}
            alt="NOIR studio brief papers — we don't decorate brands, we argue for them"
            className="h-full max-h-140 w-full object-cover md:max-h-none"
          />
        </div>

        <div className="flex flex-col justify-center px-8 py-16 md:px-24 md:py-20">
          <p className="text-[10px] tracking-[0.3em]">LET&rsquo;S CONNECT</p>
          <h2 className="mt-6 font-serif text-3xl md:text-4xl">
            The <em>Brief</em> Before The Brand.
          </h2>
          <p className="mt-8 max-w-md text-justify text-[10px] leading-relaxed text-ink/75">
          ...
          <p className="mt-4 max-w-md text-justify text-[10px] leading-relaxed text-ink/75">
          ...
          <a
            ...
            className="mt-10 inline-block self-start border border-ink px-6 py-3 text-[10px] tracking-[0.28em] transition-colors hover:bg-ink hover:text-cream"
          >
            WORK WITH US
          </a>
        </div>
