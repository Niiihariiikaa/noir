        ...
        <div className="flex flex-col justify-center px-8 py-16 md:border-r md:border-ink/60 md:px-16 md:py-20">
          ...
          <div className="mt-2 max-w-sm">
            {steps.map((step) => (
              ...
              >
                <summary className="flex cursor-pointer list-none items-center justify-between font-serif text-base tracking-tighter uppercase marker:content-none [&::-webkit-details-marker]:hidden phone:text-xl">
                  {step.label}
